...
import com.xc.lib.view.ui.SimpleSpringListener;
import com.xc.lib.view.ui.Spring;
import com.xc.lib.view.ui.SpringConfig;
import com.xc.lib.view.ui.SpringSystem;
import com.xc.lib.view.ui.SpringUtil;
...
public class ToggleButton extends View {
	...
	public void setup(AttributeSet attrs) {
		...
		// offBorderColor =
		// typedArray.getColor(R.styleable.ToggleButton_offBorderColor,
		// offBorderColor);
		// onColor = typedArray.getColor(R.styleable.ToggleButton_onColor,
		// onColor);
		...
		// offColor);
		// borderWidth =
		// typedArray.getDimensionPixelSize(R.styleable.ToggleButton_borderWidth,
		// borderWidth);
		// defaultAnimate =
		// typedArray.getBoolean(R.styleable.ToggleButton_animate,
		// defaultAnimate);
		// typedArray.recycle();
		ToggleConfig tc = getConfig();
		if (tc != null) {
			offBorderColor = tc.offborderColor == 0 ? offBorderColor
					: tc.offborderColor;
			onColor = tc.onColor == 0 ? onColor : tc.onColor;
			spotColor = tc.spotColor == 0 ? spotColor : tc.spotColor;
			offColor = tc.offColor == 0 ? offColor : tc.offColor;
			borderWidth = tc.borderWidth == 0 ? borderWidth : tc.borderWidth;

			defaultAnimate = tc.defaultAnimate ? defaultAnimate
					: tc.defaultAnimate;
		}
	...
	public class ToggleConfig {
		public int offborderColor, onColor, spotColor, offColor, borderWidth;
