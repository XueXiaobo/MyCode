...
import com.xc.lib.xutils.http.HttpCache;
import com.xc.lib.xutils.http.HttpHandler;
import com.xc.lib.xutils.http.RequestParams;
import com.xc.lib.xutils.http.ResponseStream;
import com.xc.lib.xutils.http.SyncHttpHandler;
import com.xc.lib.xutils.http.callback.HttpRedirectHandler;
import com.xc.lib.xutils.http.callback.RequestCallBack;
import com.xc.lib.xutils.http.client.DefaultSSLSocketFactory;
import com.xc.lib.xutils.http.client.HttpRequest;
import com.xc.lib.xutils.http.client.RetryHandler;
import com.xc.lib.xutils.http.client.entity.GZipDecompressingEntity;
import com.xc.lib.xutils.task.PriorityExecutor;
import com.xc.lib.xutils.util.OtherUtils;
...
public class HttpUtils {
	...
	public HttpUtils(SSLSocketFactory ssl) {
		this(HttpUtils.DEFAULT_CONN_TIMEOUT, null, ssl);
	}
	...
	public HttpUtils(int connTimeout, String userAgent) {
		this(connTimeout, userAgent, null);
	}

	public HttpUtils(int connTimeout, String userAgent, SSLSocketFactory ssl) {
