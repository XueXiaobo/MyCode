...
import com.xc.lib.xutils.db.annotation.*;
import com.xc.lib.xutils.db.annotation.Column;
import com.xc.lib.xutils.db.annotation.Finder;
import com.xc.lib.xutils.db.annotation.Foreign;
import com.xc.lib.xutils.db.annotation.Id;
import com.xc.lib.xutils.db.converter.ColumnConverter;
import com.xc.lib.xutils.db.converter.ColumnConverterFactory;
import com.xc.lib.xutils.db.sqlite.FinderLazyLoader;
import com.xc.lib.xutils.db.sqlite.ForeignLazyLoader;
import com.xc.lib.xutils.util.LogUtils;
...
public class ColumnUtils {
	...
	private static final HashSet<String> DB_PRIMITIVE_TYPES = new HashSet<String>(
			14);
	...
	public static Class<?> getForeignEntityType(
			com.xc.lib.xutils.db.table.Foreign foreignColumn) {
		Class<?> result = foreignColumn.getColumnField().getType();
		if (result.equals(ForeignLazyLoader.class) || result.equals(List.class)) {
			result = (Class<?>) ((ParameterizedType) foreignColumn
					.getColumnField().getGenericType())
	...
	public static Object convert2DbColumnValueIfNeeded(final Object value) {
		...
		if (value != null) {
			...
			if (!isDbPrimitiveType(valueType)) {
				ColumnConverter converter = ColumnConverterFactory
						.getColumnConverter(valueType);
				if (converter != null) {
